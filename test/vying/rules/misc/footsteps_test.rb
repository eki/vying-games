...
class TestFootsteps < Minitest::Test
  ...
  def test_sealed_moves
    ...
    assert_equal(%w(4 5), g.history.censored_sequence(:left))
    assert_equal(%w(4 5), g.history.censored_sequence(:right))
    assert_equal(%w(4 5), g.history.censored_sequence(nil))
    ...
    assert_equal(%w(4 5 6), g.history.censored_sequence(:right))
    ...
    assert_equal(%w(4 5 6 4), g.history.censored_sequence(:left))
    assert_equal(%w(4 5 6 4), g.history.censored_sequence(:right))
    assert_equal(%w(4 5 6 4), g.history.censored_sequence(nil))
