...
class TestThreeMusketeers < Minitest::Test
  include RulesTests
  ...
  def test_game01
    g = play_sequence %w(a5b5 a4a5 b5c5 a5b5 e1d1 e2e1 d1c1)
  ...
  def test_game02
    g = play_sequence %w(a5a4 b5a5 a4a5 b4a4 e1d1 e2e1
