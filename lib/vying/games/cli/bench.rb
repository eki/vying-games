...
module CLI
  ...
  def self.bench
    ...
    opts.banner = 'Usage: vg bench [options]'
  ...
  module Bench
    ...
    def self.formats(h)
      ...
      Benchmark.bm(30) do |x|
        ...
        x.report('json') do
          n.times { Vying::Games.load(Vying::Games.dump(g, :json), :json) }
        end
        ...
        game_hash_json = Vying::Games.dump(g, :json)
        ...
        x.report('load hash') do
          n.times { Vying::Games.load(game_hash, :hash) }
        end
