...
module Vying::Games
  ...
  # Rules is the core of the Vying::Games library.  To add a game to the library
  ...
  class Rules
    ...
    class << self
      ...
      def create(class_name, &block)
        ...
        unless rules.broken?
          Vying::Games.const_set(class_name, rules)
    ...
    class << self
      ...
      def require_all
        Dir.glob("#{Vying::Games.root}/lib/vying/games/rules/**/*.rb") do |f|
          require f.to_s
        end
      end
